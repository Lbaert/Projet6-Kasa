...
import './about.scss';
import bannerImageAbout from '../../img/banner-about.png';
...
export default function About() {
  return (
    <div className="about">
      ...
      <Collapse title="Flabilité" content="Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et
